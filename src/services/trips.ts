...
export const tripsService = {
  ...
  async populateTripRecord(tripRec: any): Promise<TripData> {
    ...
    return {
      ...
      hostRelationship: tripRec.host_relationship || '',
      hostPhone: tripRec.host_phone || '',
      hostDocument: tripRec.host_document || '',
      companionDetails: tripRec.companion_details || '',
      accommodationDetails: tripRec.accommodation_details || {},
  ...
  async saveTrip(userId: string, trip: Partial<TripData>): Promise<string> {
    const payload = {
      ...
      host_relationship: trip.hostRelationship || '',
      host_phone: trip.hostPhone || '',
      host_document: trip.hostDocument || '',
      companion_details: trip.companionDetails || '',
      accommodation_details: trip.accommodationDetails || {},
